...
The following example creates five route definitions, configures the router using the `RouterModule.forRoot()` method, and adds the result to the `AppModule`'s `imports` array.
